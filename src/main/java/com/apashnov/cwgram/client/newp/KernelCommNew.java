...
public class KernelCommNew implements NotificationsService.NotificationObserver{
    private static final String LOGTAG = "KERNELCOMM";
    private static final String LANGUAGE_EN = "en";
    private static final String botVersion = "0.1";
    private static final String botName = "Deepthought1";
    ...
    public KernelCommNew(int apiKey, AbsApiState apiState) {
    ...
    public void setMainHandler(@NotNull MainHandlerWithoutHandlerDiff mainHandler) {
    ...
    private TelegramFunctionCallback<TLAbsUpdates> getDefaultSendMessageCallback(final @NotNull IUser user) {
        return new GenericErrorTelegramFunctionCallback<TLAbsUpdates>() {
            ...
            public void onSuccess(TLAbsUpdates result) {
                if (result != null) {
                    KernelCommNew.this.handleUpdates(result);
                }
            }
        };
    }
